...
contract BryanEX is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    event TradingEnabled(uint256);

    string public constant name = "Bryan Example";
    string public constant symbol = "BryanEX";
    ...
    address payable public marketingWallet =
        payable(0x7E3332cc149AbA3c66d4aF90B13887d7D6E9f697);
    ...
    uint256 public devShare = 6;
    uint256 public mktShare = 4;
    ...
    constructor() {
        ...
        if (block.chainid == 56) {
            ...
            _isPresaleNoFee[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true; //PinkSale Lock
        } else if (block.chainid == 97) {
            currentRouter = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // PCS Testnet
            _isPresaleNoFee[0x5E5b9bE5fd939c578ABE5800a90C566eeEbA44a5] = true; //PinkSale Lock
            ...
            _isPresaleNoFee[0xeBb415084Ce323338CFD3174162964CC23753dFD] = true; //PinkSale Lock
        } else if (block.chainid == 1 || block.chainid == 5) {
            currentRouter = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //Mainnet
            _isPresaleNoFee[0x71B5759d73262FBb223956913ecF4ecC51057641] = true; //PinkSale Lock
        } else {
    ...
    function swapAndLiquify() public lockTheSwap {
        ...
        uint devAmount = (ethBalance * devShare) / 100;
        uint mktAmount = ethBalance - devAmount;

        transferToAddressETH(marketingWallet, mktAmount);
        transferToAddressETH(devWallet, devAmount);
